...
namespace SmartAdmin.WebUI.Extensions
{
    public static class IdentityExtensions
    {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> UpdateAsync<T>(this ApplicationDbContext context, T model, long id) where T : class
        {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> DeleteAsync<T>(this ApplicationDbContext context, long id) where T : class
        {
            var entity = await context.FindAsync<T>(id);
        ...
        {
           return Convert.ToInt64(claims.FindFirstValue(ClaimTypes.NameIdentifier));
        }
    }
}
